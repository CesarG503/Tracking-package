        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-foreground-muted mt-1">Registra un nuevo usuario en el sistema</p>
                </div>
            </div>

            {{-- Form --}}
            <form action="{{ route('usuarios.store') }}" method="POST" class="bg-surface rounded-2xl p-6 shadow-sm border border-border space-y-6" id="usuario-form">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" required 
                            class="w-full px-4 py-3 bg-surface-secondary border border-border rounded-xl text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent @error('nombre') !border-danger @enderror" 
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" required 
                            class="w-full px-4 py-3 bg-surface-secondary border border-border rounded-xl text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent @error('email') !border-danger @enderror" 
                    ...
                    <div>
                        ...
                        <input type="text" name="telefono" id="telefono" value="{{ old('telefono') }}" 
                            class="w-full px-4 py-3 bg-surface-secondary border border-border rounded-xl text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent @error('telefono') !border-danger @enderror" 
                    ...
                    {{-- Password --}}
                    <div>
                        <label for="password" class="block text-sm font-medium text-foreground-muted mb-2">Contraseña *</label>
                        <div class="relative">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password_confirmation" id="password_confirmation" required 
                                class="w-full px-4 py-3 bg-surface-secondary border border-border rounded-xl text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                    ...
                    <div>
                        ...
                        <select name="rol" id="rol" required 
                            ...
                            <option value="repartidor" {{ old('rol') === 'repartidor' ? 'selected' : '' }}>Repartidor</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="licencia" id="licencia" value="{{ old('licencia') }}" 
                            class="w-full px-4 py-3 bg-surface-secondary border border-border rounded-xl text-foreground font-mono placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent @error('licencia') !border-danger @enderror" 
                            placeholder="Solo para repartidores">
                        @error('licencia')
                            <p class="mt-1 text-sm text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex items-center gap-3 p-4 bg-surface-secondary rounded-xl">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="activo" id="activo" value="1" {{ old('activo', true) ? 'checked' : '' }} class="sr-only peer">
