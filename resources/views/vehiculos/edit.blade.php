                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="estado" id="estado" required 
                                    ...
                                    <option value="asignado" {{ old('estado',$vehiculo->estado) === 'asignado' ? 'selected' : '' }}>Asignado</option>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-3 gap-3" id="current-photos">
                                ...
                                <div class="aspect-square rounded-xl overflow-hidden relative group" id="photo-{{ $index }}">
                                    <img src="{{ asset('storage/' . $foto) }}" alt="Foto vehiculo" class="w-full h-full object-cover">
