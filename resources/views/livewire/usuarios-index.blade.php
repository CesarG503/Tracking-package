    ...
    <div class="bg-surface dark:bg-surface rounded-2xl p-4 mb-6 shadow-sm border border-border dark:border-border transition-colors duration-300">
        <div class="flex items-center gap-4 flex-wrap">
            <div class="flex-1 min-w-[200px] relative">
                ...
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Buscar por nombre, email..." 
            ...
            <select wire:model.live="rol" class="px-4 py-3 bg-surface-secondary border border-border rounded-xl min-w-[150px] text-foreground focus:outline-none focus:ring-2 focus:ring-primary cursor-pointer">
                <option value="">Todos los roles</option>
                <option value="admin">Administrador</option>
                <option value="repartidor">Repartidor</option>
            </select>

            <select wire:model.live="activo" class="px-4 py-3 bg-surface-secondary border border-border rounded-xl min-w-[140px] text-foreground focus:outline-none focus:ring-2 focus:ring-primary cursor-pointer">
